      ...
      <div>
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <div className="w-[162px] h-[42px] flex flex-row justify-between items-center p-4 bg-neutral-800 border-neutral-600 rounded-3xl text-[14px] border cursor-pointer">
              <div>최근활동</div>
              <div>
                <AiFillCaretDown />
              </div>
